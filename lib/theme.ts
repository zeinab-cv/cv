...
export const getThemeClasses = () => {
  return {
    ...
    skillPill: "px-3 py-1 bg-white/10 text-white/80 text-sm rounded-full border border-white/20 hover:bg-gradient-to-br hover:from-yellow-300/20 hover:via-orange-400/30 hover:to-red-300/20 transition-colors duration-300"
  };
}; 